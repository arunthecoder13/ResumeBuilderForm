...
export const LeftSidebar = ({ curentStep }: { curentStep: number }) => {
    return (
        <div className="hidden lg:flex w-[25%] flex-col bg-[#304767] p-7 rounded-l-2xl">
            ...
            <div className="my-7">
                <h4 className="font-semibold text-white text-xl">Step {curentStep === 0 ? curentStep + 1 : curentStep}</h4>
            ...
            <div className="my-10 flex flex-col justify-center items-center">
                <ol className="relative text-gray-500 border-s border-gray-200">
                    <li className="mb-10 ms-10">
                        <span className={`absolute flex items-center justify-center w-9 h-9 ${curentStep >= 1 ? 'bg-green-200' : 'bg-gray-100'} rounded-full -start-5 ring-4 ring-white`}>
                    ...
                    <li className="mb-10 ms-10">
                        <span className={`absolute flex items-center justify-center w-9 h-9 ${curentStep >= 2 ? 'bg-green-200' : 'bg-gray-100'} rounded-full -start-5 ring-4 ring-white`}>
                    ...
                    <li className="mb-10 ms-10">
                        <span className={`absolute flex items-center justify-center w-9 h-9 ${curentStep >= 3 ? 'bg-green-200' : 'bg-gray-100'} rounded-full -start-5 ring-4 ring-white`}>
                    ...
                    <li className="ms-10">
                        ...
                        <p className={`text-sm ${curentStep >= 3 && 'text-white'}`}>Final Submitted</p>
                    </li>
                </ol>
            </div>
        </div>
